...
import ru.practicum.shareit.booking.type.BookingState;
...
public class BookingServiceImpl implements BookingService {
    ...
    public List<BookingResponseDto> getBookingsByBookerIdAndState(Long bookerId, String state, Pageable pageable) {
        BookingState bookingState = checkStateType(state);
    ...
    private BookingState checkStateType(String state) {
        return BookingState.from(state)
                .orElseThrow(() -> new IllegalArgumentException("Unknown state: " + state)); //StatusTypeException
    }
}
